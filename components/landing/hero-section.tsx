...
export function HeroSection() {
  return (
    <section className="hero-gradient-field relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="hero-grid absolute inset-0" />
        <div className="hero-light hero-light-one absolute" />
        <div className="hero-light hero-light-two absolute" />
        <div className="hero-sweep absolute inset-x-0 top-0 h-full" />
      </div>

      <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 sm:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          <span className="hero-kicker inline-flex items-center gap-2 rounded-full border border-border bg-card/85 px-4 py-1.5 text-xs font-medium text-muted-foreground shadow-sm backdrop-blur-md">
            <Sparkles className="h-3.5 w-3.5 text-brand-purple" />
            Turn real-world news into smarter money decisions
          </span>
          <h1 className="mt-6 text-balance text-4xl font-bold leading-tight text-foreground sm:text-6xl">
            <PaintedWord tone="blue">Spend Smarter.</PaintedWord>{" "}
            <PaintedWord tone="purple" delay>
              Invest Better.
            </PaintedWord>
          </h1>
...
function HeroPreview() {
  return (
    <div className="hero-preview-float mx-auto mt-14 max-w-4xl">
      <div className="rounded-3xl border border-border/80 bg-card/85 p-2 shadow-xl shadow-primary/10 backdrop-blur-xl">
        <div className="rounded-2xl border border-border/80 bg-secondary/45 p-4 sm:p-6">
...
function PaintedWord({
  ...
  return (
    <span
      className={`painted-word painted-word-${tone}${delay ? " painted-word-delay" : ""}`}
    >
      {children}
    </span>
  );
